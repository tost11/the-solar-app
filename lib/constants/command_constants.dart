...
const String COMMAND_TURN_ON_INVERTER = "turn-on-inverter";
const String COMMAND_TURN_OFF_INVERTER = "turn-off-inverter";
const String COMMAND_FETCH_HIST_POWER = "fetch-hist-power";
const String COMMAND_FETCH_HIST_ENERGY = "fetch-hist-energy";
